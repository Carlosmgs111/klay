...
import type { ConfigProvider } from "../../../../platform/config/index";
  ...
  private static async resolveConfig(
    ...
    if (policy.configOverrides) {
      const { InMemoryConfigProvider } =
        await import("../../../../platform/config/InMemoryConfigProvider");
    ...
    switch (policy.type) {
      ...
      default: {
        ...
        const { NodeConfigProvider } =
          await import("../../../../platform/config/NodeConfigProvider");
